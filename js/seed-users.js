// seed/seed-users.js
//
// Creates REAL, working login accounts: a Firebase Auth user + the matching
// users/{uid} Firestore profile, for each entry below. Run this once locally
// (not in the browser) with a Firebase service account key.
//
// SETUP:
//   1. npm install firebase-admin
//   2. Firebase Console → Project settings → Service accounts →
//      "Generate new private key" → save as seed/service-account.json
//      (keep this file OUT of git / never ship it to the browser)
//   3. node seed/seed-users.js
//
// Edit the ACCOUNTS list below before running — change the passwords.
